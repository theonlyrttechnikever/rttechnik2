...
import { CalendarDays, Clock, ArrowRight } from "lucide-react" // stripHtml, formatDate, calculateReadingTime
...
async function BlogContent() {
  const [posts, categories] = await Promise.all([getLocalPosts("blog", "pl"), getLocalCategories("pl")])
  ...
  const featuredMedia = featuredPost?.featured_media
