...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  // Assuming English for this route. For Polish, you might have /pl/blog/[slug]
  const post = await getLocalPost("blog", params.slug, "en")
...
export async function generateStaticParams() {
  const posts = await getLocalPosts("blog", "en")
